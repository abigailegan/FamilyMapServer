...
6.	Once it is done loading, make sure the main function found in FamilyMap.java runs without errors. It is found inside the project in the ``src/main/java/FamilyMap.java`` directory. 
